...
error_map = {
    ...
    RET.PERMISSIONERR         : u"权限不足",
}


class PATH:
    APPS_DIR = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
    SDK_PACKAGE_DIR = os.path.join(APPS_DIR, "sdk_package")
    DOCKER_DIR = os.path.join(SDK_PACKAGE_DIR, "docker")  # 规范目录的路径
    IAS_DIR = os.path.join(SDK_PACKAGE_DIR, "ias")        # IAS目录的路径
